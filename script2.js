document.addEventListener("DOMContentLoaded", function () {
  ...
  mySelectCause.addEventListener("change", function () {
    ...
    showOrHideElement(svarInput, selectedValue === "null");
  });
  ...
  mySelectChange.addEventListener("change", function () {
    ...
    showOrHideElement(
      changeIncProviders,
      selectedValue === "Отключение метода"
    );
    showOrHideElement(cascadeChange, selectedValue === "Изменение каскада");
    showOrHideElement(am_text, mySelectChange.value === "null");
  });

  // Initial state
  showOrHideElement(svarInput, mySelectCause.value === "null");
  showOrHideElement(
    changeIncProviders,
    mySelectChange.value === "Отключение метода"
  );
  showOrHideElement(
    cascadeChange,
    mySelectChange.value === "izИзменение каскадаka"
  );
  showOrHideElement(am_text, mySelectChange.value === "null");
